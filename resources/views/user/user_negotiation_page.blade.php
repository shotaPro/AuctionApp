        ...
        <script>
            ...
            for (let i = 0; i < suggets_btn.length; i++) {
                ...
                suggets_btn[i].addEventListener('click', function(e) {
                    ...
                    let product_id = e.target.closest('td').previousElementSibling.previousElementSibling
                    ...
                    if (price_value.value == "" || price_value.value == undefined) {
                        ...
                        let nyuusatu_price = e.target.closest('td').previousElementSibling.previousElementSibling
                        ...
                        if (result != true) {
                            ...
                            window.location.href = 'admin_suggest_price?price=' + price_value.value + '&product_id=' +
                                product_id // 通常の遷移
            ...
            $count_accept_btn = accept_btn.length;

            if($count_accept_btn == undefined){

                accept_btn.addEventListener('click', function(e){
                    e.preventDefault();
                    let suggested_price = e.target.parentElement.previousElementSibling.textContent;
                    let product_id = e.target.parentElement.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
