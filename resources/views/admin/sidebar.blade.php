<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('event_setting_page') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-speedometer"></i>
                </span>
                <span class="menu-title">催事設定</span>
            </a>
        </li>
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('register_product_page') }}">
                <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('shuppin_page') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-playlist-play"></i>
                </span>
                <span class="menu-title">出品処理</span>
            </a>
        </li>
        <li class="nav-item menu-items">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('admin_kenpin_page') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-contacts"></i>
                </span>
                <span class="menu-title">検品処理</span>
            </a>
        </li>
        <li class="nav-item menu-items">
